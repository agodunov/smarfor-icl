...
For more technical details, read the code itself with comments and pictures. I have chosed to implement Pandas dataframe and save data in excel which I find convenient for the data analysis.
